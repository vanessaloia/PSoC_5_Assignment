    ...
    /* accelerometer's output data are sent through UART in 4 bytes for axis 
    since they are saved in a long int (32 bytes) */
    #define NUM_BYTES 4
    ...
    /* array that contain data to send through UART: 12 bytes + 2 bytes (header+tail) */
